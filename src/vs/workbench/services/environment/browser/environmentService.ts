...
import { IWorkbenchConstructionOptions, IEduCompilerServiceConfiguration } from '../../../browser/web.api.js';
...
export class BrowserWorkbenchEnvironmentService implements IBrowserWorkbenchEnvironmentService {
    ...
    @memoize
    get eduCompilerService(): IEduCompilerServiceConfiguration | undefined {
        return this.options.eduCompilerService;
    }
